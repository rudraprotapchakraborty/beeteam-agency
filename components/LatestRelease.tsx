  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <div>
            {t.resolution} · <span className="text-black font-semibold">4K UHD</span>
          </div>
          <div>
            {t.client} · <span className="text-black font-semibold">Financial Express</span>
          </div>
          <div>
            {t.duration} · <span className="text-[#D97706] font-semibold">02:44</span>
          </div>
        </motion.div>
      </div>
    </section>
