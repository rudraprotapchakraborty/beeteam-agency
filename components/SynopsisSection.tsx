      ...
      >
        <div className="grid lg:grid-cols-12 gap-12">
          <motion.div
            ...
            style={{ color: '#FFD700' }}
          >
            <p className="text-sm tracking-[0.3em] uppercase mb-6">{t.presents}</p>

            <h2 className="text-5xl md:text-6xl leading-tight">{t.title}</h2>
          ...
          <motion.div
            ...
            style={{ color: '#FFD700' }}
          >
            <p className="text-lg md:text-xl leading-relaxed whitespace-pre-line">{t.text}</p>
          </motion.div>
        </div>
