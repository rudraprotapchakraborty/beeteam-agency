...
export default function BeeTeamProfessionalHero() {
  ...
  return (
    <section id='hero' ref={containerRef} className="relative h-[200vh] bg-white overflow-clip selection:bg-black selection:text-white">
      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <AnimatePresence>
          {!hasOpened && (
            ...
            >
              <motion.div style={{ x: leftCurtainX }} className="h-full w-1/2 bg-black border-r border-white/10" />
              <motion.div style={{ x: rightCurtainX }} className="h-full w-1/2 bg-black border-l border-white/10" />
              
              <motion.div style={{ opacity: introOpacity }} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[151] flex flex-col items-center gap-8">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-white text-[10px] tracking-[1.2em] font-black uppercase">Initiating</span>
                </div>
              </motion.div>
            </motion.div>
          )}
        ...
        <motion.div style={{ y: bgTextY }} className="absolute inset-0 flex items-center justify-center select-none z-0">
          <h2 className="text-[25vw] font-black text-black/[0.06] leading-none uppercase tracking-tighter">EST.2026</h2>
        </motion.div>
        ...
        >
          ...
          <div className="lg:col-span-7 relative group">
            <a 
              ...
              className="block relative overflow-hidden border-[10px] border-black shadow-[30px_30px_0px_rgba(0,0,0,0.1)] cursor-pointer"
            >
              <motion.div style={{ scale: imageScale }} className="relative overflow-hidden">
                <img src="https://epaper.thefinancialexpress.com.bd/2026/01/21/images/24_100.jpg" className="w-full aspect-video object-cover" alt="Feature" />
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="flex items-center gap-3 bg-white px-6 py-3 shadow-[8px_8px_0px_#FFD700]">
                    <span className="text-black font-black text-[10px] tracking-widest uppercase">Open_Article</span>
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-8">
            <div className="flex items-center gap-4">
                <div className="bg-black text-white px-3 py-1 text-[10px] font-black uppercase tracking-widest">Global_Directive</div>
                <div className="h-1 w-12 bg-[#FFD700]" />
            </div>
            <h1 className="text-7xl xl:text-[120px] font-black leading-[0.75] tracking-tighter text-black uppercase">
              Elite <br /> 
              <span className="text-white bg-black px-4 ml-[-1rem]">Agency.</span>
            </h1>
            <p className="text-xl text-black font-bold leading-tight max-w-sm uppercase tracking-tight">
              Engineering cinematic authority for the world’s most <span className="text-[#D97706]">aggressive brands</span>. 
            </p>
            ...
            >
              Contact <ArrowDown size={18} strokeWidth={4} className="group-hover:translate-y-1 transition-transform" />
            </motion.button>
          </div>
        </motion.div>
      </div>
