...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden font-sans mb-24">
      <div className="absolute inset-0">
        <img src="/hero.jpg" alt="Beeteam Background" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center pt-24 px-6 text-white">
        ...
        >
          ...
          <div className="space-y-4 text-xl leading-normal text-white/90 mb-24">
            ...
            <p className="text-[#FFD700] pt-3">{t.endingLine}</p>
            <p className="text-[#FFD700] text-lg">{t.finalQuestion}</p>
          </div>
        </motion.div>
      </div>
    </section>
