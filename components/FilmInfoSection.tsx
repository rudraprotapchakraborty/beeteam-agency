        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <Reveal className="lg:col-span-5">
            <motion.div style={{ y: posterY, rotate: posterRotate }} className="relative mx-auto max-w-md">
              <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-gold/20 via-transparent to-transparent blur-2xl" />
          ...
          <div className="lg:col-span-7">
            <Reveal>
              <SectionEyebrow index="/04" label={t.eyebrow} />
            ...
            <Reveal delay={0.08}>
              <div className="mb-8 relative rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/10 to-transparent p-6 md:p-8 overflow-hidden">
                ...
                <p className="font-display text-4xl md:text-5xl text-(--gold-text)">{t.creator}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              <div className="grid sm:grid-cols-2 gap-px rounded-2xl overflow-hidden border border-line bg-fill-hover">
                {specs.map((spec) => (
                  <div key={spec.label} className="bg-card p-5 group hover:bg-page-3 transition-colors">
                    ...
                    {spec.href ? (
                      <a
                        ...
                        className="text-base font-medium text-fg group-hover:text-(--gold-text) transition-colors"
                      >
                        {spec.value}
                      </a>
                    ) : (
                      <span
                        ...
                        } group-hover:text-(--gold-text) transition-colors`}
                      >
                        {spec.value}
                      </span>
                    )}
